...
public class InterestTrainDialog extends DialogFragment
{
	boolean isNull = true;
	...
	public void setDetails(TrainInfo info)
	{
		...
		String[] estimateArrInfo = WebExtract.calEstimateTime(info.getDepDate(), info.getArrTime(), info.getDelayTime());
		String delayTime;
		...
		trainStatusView.setText(info.getStatus());
